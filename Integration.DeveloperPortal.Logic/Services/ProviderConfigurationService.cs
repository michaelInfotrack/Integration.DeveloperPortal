...
{
    public class ProviderConfigurationService : IProviderConfigurationLogic
    {
        private readonly IProviderConfigurationRepository _providerConfigurationRepository;

        public ProviderConfigurationService(IProviderConfigurationRepository providerConfigurationRepository)
        {
        ...
        private ProviderConfiguration MapToEntity(ProviderConfigurationModel providerConfigurationModel)
        {
            ...
            {
                ProviderConfigurationId = providerConfigurationModel.ProviderConfigurationId,
                ...
                TokenProviderEndpoint = providerConfigurationModel.TokenProviderEndpoint,
                TokenClientId = providerConfigurationModel.TokenClientId,
                TokenClientSecret = providerConfigurationModel.TokenClientSecret,
                TokenScope = providerConfigurationModel.TokenScope,
                TokenGrantType = providerConfigurationModel.TokenGrantType,
            };
        }
        ...
        private ProviderConfigurationModel MapToModel(ProviderConfiguration providerConfiguration)
        {
            return new ProviderConfigurationModel
            {
                ...
                TokenProviderEndpoint = providerConfiguration.TokenProviderEndpoint,
                TokenClientId = providerConfiguration.TokenClientId,
                TokenClientSecret = providerConfiguration.TokenClientSecret,
                TokenScope = providerConfiguration.TokenScope,
                TokenGrantType = providerConfiguration.TokenGrantType
            };
        }
    }
}
